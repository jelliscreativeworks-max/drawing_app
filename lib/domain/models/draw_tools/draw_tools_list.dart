...
import 'package:drawing_app/domain/models/draw_tools/erase_tool.dart';
...
class DrawToolsList {
  ...
  static DrawTool erase = EraseTool(toolName: 'Erase Tool', toolIcon: Icon(Symbols.ink_eraser));
